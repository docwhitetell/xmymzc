<header id="header" class="header header-hide">
    <div class="container">
        ...
        <div id="logo" class="pull-left">
            ...
            {{--<a href="#body"><img src="{{asset('img/brand.jpg')}}" alt="" title="" /></a>--}}
        </div>

        <nav id="nav-menu-container">
            <ul class="nav-menu">
                <li><a href="javascript:void(0)" class="nav-link-item" data-index="1">首页</a></li>
                <li><a href="javascript:void(0)" class="nav-link-item" data-index="2">关于优铭</a></li>
